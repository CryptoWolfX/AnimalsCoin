...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Animalscoin " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x62c1c658,0x9540825e,0xbe6b042e,
0x10bf4528,0xcf3dbe14,
0xd2f55a0d,0xf421ad34
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Animalscoin is probably already running."), addrBind.ToString().c_str());
        else
